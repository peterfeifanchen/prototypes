...
class st{
   ...
   int callGet( int desiredL, int desiredR, int index, int curL, int curR ) {
      ...
      if( curL > desiredR || curR < desiredL ) return INT_MAX;
...
int main() {
   ...
   std::cout << "sum[0, 5]=" << s.get(0, 5) << std::endl; //1
   std::cout << "sum[0, 4]=" << s.get(0, 4) << std::endl; //1
   std::cout << "sum[0, 3]=" << s.get(0, 3) << std::endl; //1
   std::cout << "sum[1, 5]=" << s.get(1, 5) << std::endl; //3
   std::cout << "sum[1, 4]=" << s.get(1, 4) << std::endl; //3 
   std::cout << "sum[1, 3]=" << s.get(1, 3) << std::endl; //3
   std::cout << "sum[3, 3]=" << s.get(3, 3) << std::endl; //7
   std::cout << "sum[5, 5]=" << s.get(5, 5) << std::endl; //11
   std::cout << "sum[1, 6]=" << s.get(1, 6) << std::endl; //3
   std::cout << "sum[2, 6]=" << s.get(2, 6) << std::endl; //5
   std::cout << "sum[2, 10]=" << s.get(2, 10) << std::endl; //5
   ...
   std::cout << "sum[3, 3]=" << s.get(3, 3) << std::endl; //7
   std::cout << "sum[5, 5]=" << s.get(5, 5) << std::endl; //11
   std::cout << "sum[1, 6]=" << s.get(1, 6) << std::endl; //30
   std::cout << "sum[2, 6]=" << s.get(2, 6) << std::endl; //5
   std::cout << "sum[2, 10]=" << s.get(2, 10) << std::endl; //5
   
   s.update( 2, 5, 0 );
   std::cout << "sum[0, 5]=" << s.get(0, 5) << std::endl; //0
   std::cout << "sum[0, 4]=" << s.get(0, 4) << std::endl; //0
   std::cout << "sum[0, 3]=" << s.get(0, 3) << std::endl; //0
   std::cout << "sum[1, 5]=" << s.get(1, 5) << std::endl; //0
   std::cout << "sum[1, 4]=" << s.get(1, 4) << std::endl; //0 
   std::cout << "sum[1, 3]=" << s.get(1, 3) << std::endl; //0
   std::cout << "sum[3, 3]=" << s.get(3, 3) << std::endl; //7
   std::cout << "sum[5, 5]=" << s.get(5, 5) << std::endl; //11
   std::cout << "sum[1, 6]=" << s.get(1, 6) << std::endl; //0
   std::cout << "sum[2, 6]=" << s.get(2, 6) << std::endl; //0
   std::cout << "sum[2, 10]=" << s.get(2, 10) << std::endl; //0
}
